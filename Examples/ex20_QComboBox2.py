...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # self.cb.textActivated.connect(self.changed_item)
        # self.cb.textHighlighted.connect(self.changed_item)
        self.cb.editTextChanged.connect(self.changed_item)

        btn.clicked.connect(self.on_clicked_btn)
        btn_add.clicked.connect(self.on_clicked_btn_add)
